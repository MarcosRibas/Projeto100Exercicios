"""
Ex107 “Exercitando módulos em Python” Crie um módulo chamado moeda.py que tenha as funções incorporadas aumentar(),
...
print(f'Diminuido 10%, temos R${moeda.diminuir(preço, 10)}')